...
<div id="div-glowny">
	...
	<br>
	<form action="tworzenie_licytacji_skrypt.php" method="post" enctype="multipart/form-data">
		<div class="form-group">
			<label for="nazwa">
				Nazwa oferty
			</label>
			<input id="nazwa" name="nazwa" type="text" class="form-control<?php echo Walidacja::dodajKlaseIsInvalid("tworzenieLicytacjiBladNazwa"); ?>" placeholder="Nazwa oferty" <?php echo Walidacja::zwrocStaraWartosc("staraNazwa"); ?>/>
			<small id="nazwa-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladNazwa");
				?>
			</small>
		</div>
		<div class="form-group">
			...
			<input id="cena" name="cena" type="number" step="0.01" class="form-control<?php echo Walidacja::dodajKlaseIsInvalid("tworzenieLicytacjiBladCena"); ?>" placeholder="Minimalna cena" <?php echo Walidacja::zwrocStaraWartosc("staraCena"); ?>/>
			<small id="cena-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladCena");
				?>
			</small>
		</div>
		<div class="form-group">
			...
			<input id="data-koniec" name="data-koniec" type="datetime-local" class="form-control<?php echo Walidacja::dodajKlaseIsInvalid("tworzenieLicytacjiBladDataKoniec"); ?>" placeholder="Data zakończenia licytacji" <?php echo Walidacja::zwrocStaraWartosc("staraDataKoniec"); ?>/>
			<small id="data-koniec-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladDataKoniec");
				?>
			</small>
		</div>
		<div class="form-group">
			...
			<br>
			<select id="kategoria" name="kategoria" class="form-control<?php echo Walidacja::dodajKlaseIsInvalid("tworzenieLicytacjiBladKategoria"); ?>" onchange="aktywujKontrolki('Artykuły spożywcze', 'kategoria', 'stan-nowy'); aktywujKontrolki('Artykuły spożywcze', 'kategoria', 'stan-uzywany');">
			...
			<small id="kategoria-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladKategoria");
				?>
			</small>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<small id="stan-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladStan");
				?>
			</small>
		</div>
		...
		<div class="form-group">
			...
			<small id="dostawa-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladDostawa");
				?>
			</small>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input id="czas-na-zwrot" name="czas-na-zwrot" type="number" min="14" class="form-control<?php echo Walidacja::dodajKlaseIsInvalid("tworzenieLicytacjiBladCzasNaZwrot"); ?>" placeholder="Czas na odstąpienie od umowy (w dniach)"/>
			<small id="czas-na-zwrot-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladCzasNaZwrot");
				?>
			</small>
		</div>
		<div class="form-group">
			...
			<textarea id="adres-zwrotu" name="adres-zwrotu" class="form-control<?php echo Walidacja::dodajKlaseIsInvalid("tworzenieLicytacjiBladAdresZwrotu"); ?>" placeholder="Adres do zwrotu"><?php Walidacja::wypiszStaraWartosc("staryAdresZwrotu"); ?></textarea>
			<small id="adres-zwrotu-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladAdresZwrotu");
				?>
			</small>
		</div>
		<div class="form-group">
			...
			<small id="zwroty-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladKosztyZwrotu");
				?>
			</small>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input id="gwarancja" name="gwarancja" type="number" class="form-control<?php echo Walidacja::dodajKlaseIsInvalid("tworzenieLicytacjiBladGwarancja"); ?>" placeholder="Okres gwarancji (w miesiącach)" min="0" <?php echo Walidacja::zwrocStaraWartosc("staraGwarancja"); ?>/>
			<small id="gwarancja-blad" class="form-text text-muted walidacja-blad">
				<?php
					Walidacja::wyswietlKomunikatOBledzie("tworzenieLicytacjiBladGwarancja");
				?>
			</small>
		</div>
		<div class="form-group">
		...
		<button type="submit" class="btn btn-success" onclick="return walidacjaTworzeniaOferty();">Utwórz licytację</button>
	</form>
</div>
<div class="div-boczny"></div>
